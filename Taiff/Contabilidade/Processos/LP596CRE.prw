...
If Alltrim(SE5->E5_TIPO)=="RA"  
                ...
                IF ALLTRIM(SE5->E5_TIPO) =="NF" .AND. SA1->A1_INTER  != "S" .AND. ALLTRIM(SE5->E5_PREFIXO) == "3"
                               cConta := "1102010003"
                
                ElseIF ALLTRIM(SE5->E5_TIPO) =="NF" .AND. SA1->A1_INTER  =="S"
                               cConta := "1102010002"
...
ElseIf Alltrim(SE5->E5_TIPO)=="NF"  
                ...
                IF ALLTRIM(SE5->E5_TIPO) =="RA" .AND. SA1->A1_INTER  != "S" .AND. ALLTRIM(SE5->E5_PREFIXO) == "3"
                               cConta := "1102010003"
                
                ELSEIF ALLTRIM(SE5->E5_TIPO)=="NCC" .AND. SA1->A1_INTER  =="S"
                               cConta := "1102010002"
