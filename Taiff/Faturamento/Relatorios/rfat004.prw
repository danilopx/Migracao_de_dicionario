...
//
// O conteudo da função TRepInUse() é definido no SX6 de cada empresa, a variavel é MV_TREPORT campo X6_CONTEUD 1 ou 2.
// Objetivo é definir de que forma o relatorio será impresso via objeto ou programação ADV - Clipper
//
...
//
// Configuração do objeto original
...
If cPaisLoc == "BRA"
	...
	// Sintetico
	//oSintetico := TRSection():New(oReport,"Sintetico - Notas Fiscais",{"SF2","SD2"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
	// Inclusão da tabela SA1 na TRSection()
	oSintetico := TRSection():New(oReport,"Sintetico - Notas Fiscais",{"SF2","SD2","SA1"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
    ...
    // Inserção da linha com nome do cliente A1_NOME 14/01/2010
    ...
    // Analitico
	oCabec := TRSection():New(oReport,"Analitico - Clientes",{"SF2","SD2","SA1"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
	...
	oItens := TRSection():New(oCabec,"Analitico - Itens",{"SF2","SD2","SB1"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
	...
	// Totalizador por dia
	oTotDia := TRSection():New(oReport,"Totalizador por Dia",{"SF2","SD2"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
	...
	oTotDesp := TRSection():New(oReport,"Totalizador das Despesas Acessorias",{"SF2","SD2"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
...
Else
	...
	oCabec := TRSection():New(oReport,"Sintetico - Cabecalho NF",{"SF2"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
	oCabec:SetTotalInLine(.F.)
    ...
    // Analitico
	oItens := TRSection():New(oReport,"Analitico - Itens NF",{"SD2"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
	oItens:SetTotalInLine(.F.)
    ...
    // Total Geral
   	oTotGer := TRSection():New(oReport,"Total Geral",{"SF2","SD2"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
    ...
    // Total por dia
   	oTotDia := TRSection():New(oReport,"Total do Dia ",{"SF2","SD2"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)
	oTotDia:SetTotalInLine(.F.)
	oTotDia:SetEdit(.F.)
...
Local lQuery  := .F.
//
// Variaveis implementadas para atender necessidade de usuario PROART - Inclusão de campo nome do cliente
//--------------------------------------------------------------------------------------------------------
Local cNome     := ""
Local nLencNome := 25
Local cAliasSA1 := "SA1"
...
Cabec1	:= "PRODUTO          DESCRICAO                        DEP. PEDIDO/IT  REMITO/ITEM      QUANTIDADE    VALOR UNITARIO  VALOR MERCADORIA            IMPOSTOS      IMPOSTOS NAO     OUTROS GASTOS               TOTAL" //"PRODUCTO         DESCRIPCIàN                      DEP. PEDIDO/IT  REMITO/ITEM        CANTIDAD    VALOR UNITARIO  VALOR MERCADERIA     GRAVAMENES NO        GRAVAMENES      OTROS GASTOS               TOTAL"
