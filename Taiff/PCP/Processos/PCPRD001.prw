...
// ---------+-------------------+-----------------------------------------------------------
// 23/11/15 | TOTVS | Developer Studio | Gerado pelo Assistente de Código
// ---------+-------------------+-----------------------------------------------------------
...
dbGoTop()
If nRec > 0
	cMensText := " Este número de lote "+Alltrim(cLote)+ENTER
	cMensText += " Jà foi utilizada na OP "+TRBRD01->H6_OP+ENTER
